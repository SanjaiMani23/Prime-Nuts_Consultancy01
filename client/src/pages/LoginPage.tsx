...
import { Mail, Lock, Sparkles, ArrowRight, Eye, EyeOff, ShieldCheck, CheckCircle2 } from 'lucide-react';
...
export const LoginPage: React.FC = () => {
  ...
  const handleDemoAdmin = () => {
    setEmail('admin@theprimenuts.com');
    setPassword('Admin@123');
    setErrorMsg('');
  };

  const handleDemoCustomer = () => {
    setEmail('customer@theprimenuts.com');
    ...
    <main className="min-h-screen bg-[#FFF7E8] py-12 md:py-20 px-4 sm:px-6 lg:px-8 flex items-center justify-center selection:bg-[#F28C00] selection:text-[#2B160D]">
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-[#E5D5B5] grid grid-cols-1 md:grid-cols-12">
        ...
        <div className="md:col-span-5 bg-[#2B160D] text-[#FFF7E8] p-8 sm:p-10 flex flex-col justify-between relative overflow-hidden border-r border-[#F28C00]/20">
          ...
          {/* Quick Demo Credentials for Review/Field Presentation */}
          <div className="relative z-10 pt-8 mt-6 border-t border-[#FFF7E8]/15 text-xs space-y-2">
            <p className="text-[#F28C00] font-semibold text-[11px] uppercase tracking-wider flex items-center gap-1">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-[#FFF7E8]/10 hover:bg-[#FFF7E8]/20 border border-[#FFF7E8]/20 text-[#FFF7E8] transition-colors text-xs font-medium"
              >
                Customer Demo
              </button>
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-[#F28C00]/20 hover:bg-[#F28C00]/30 border border-[#F28C00]/40 text-[#F28C00] transition-colors text-xs font-bold"
              >
                Admin Demo
              </button>
            </div>
