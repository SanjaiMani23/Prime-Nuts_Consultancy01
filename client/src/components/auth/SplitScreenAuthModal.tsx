      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto selection:bg-[#F28C00] selection:text-[#2B160D]">
        ...
        >
          ...
          <div className="md:col-span-5 bg-[#2B160D] text-[#FFF7E8] p-8 flex flex-col justify-between relative overflow-hidden border-r border-[#F28C00]/20">
            ...
            <div className="relative z-10 pt-8 border-t border-[#FFF7E8]/15 text-xs space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#FFF7E8]/10 border border-[#FFF7E8]/20 text-[#FFF7E8] hover:bg-[#FFF7E8]/20 transition-colors text-[11px]"
                >
                  Customer Demo
                </button>
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#F28C00]/20 border border-[#F28C00]/40 text-[#F28C00] hover:bg-[#F28C00]/30 transition-colors text-[11px] font-bold"
                >
                  Admin Demo
                </button>
              </div>
